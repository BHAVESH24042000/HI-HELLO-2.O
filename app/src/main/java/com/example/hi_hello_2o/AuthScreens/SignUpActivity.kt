package com.example.hi_hello_2o.AuthScreens
...
import com.example.hi_hello_2o.MainActivity
...
const val phnumber= "phoneNumber"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nextBtn.setOnClickListener {
            ...
            if (!::downloadUrl.isInitialized) { // if photo is not inserted
                ...
                val phoneno= intent.getStringExtra(phnumber)
                val user = User(name, downloadUrl, downloadUrl/*Needs to thumbnai url*/, auth.uid!!,phoneno ) // to send data of this user to cloud
