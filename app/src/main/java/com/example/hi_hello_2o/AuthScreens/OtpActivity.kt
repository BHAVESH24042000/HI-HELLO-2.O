    ...
    private fun initView() {
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {  // code from firebase code authentication //https://firebase.google.com/docs/auth/android/phone-auth?authuser=1#kotlin+ktx
            ...
            override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                ...
                Toast.makeText(getApplicationContext(),"Verifying code Automatically",
                    Toast.LENGTH_LONG
                ).show();
        ...
        mAuth.signInWithCredential(credential)
            .addOnCompleteListener {
                if (it.isSuccessful)
                {
                    ...
                    startActivity(Intent(this, SignUpActivity::class.java).putExtra(phnumber, phoneNumber)) // after code sent and fill up, navigate to next activity to create account
                }
                else
                {
                    if (::progressDialog.isInitialized) {
